...
### Phase 2: First Data Arrival (IRB 1 & IRB 2)
...
### Phase 3: Later Data Arrival (IRB 3)
...
### Step 1.1 — Initialize the project repository
...
### Step 1.3 — Create the database and define the schema
...
### Step 1.4 — Version the empty database with DVC
...
## Phase 2: Simulating the First Data Arrival (IRB 1 & IRB 2)

### Step 2.1 — Generate mock data for IRB 1 and IRB 2
...
### Step 2.2 — Parse the raw data into a dataframe
...
### Step 2.3 — Populate the patient_registry table
...
### Step 2.4 — Populate the data_assets table
...
### Step 2.5 — Run your first completeness report
...
### Step 2.6 — Version the populated database with DVC
...
## Phase 3: Simulating a Later Data Arrival (IRB 3)

### Step 3.1 — Generate mock data for IRB 3
...
### Step 3.2 — Parse IRB 3 and identify what's new
...
### Step 3.3 — Ingest IRB 3 into the registry
...
### Step 3.4 — Reconciliation report
...
### Step 3.5 — Optional: backfill pending records from earlier IRBs
...
### Step 3.6 — Version the updated database with DVC
...
### Step 4.1 — Write the ingestion script
...
### Step 4.3 — Write the data dictionary
